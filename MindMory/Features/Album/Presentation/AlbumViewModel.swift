...
final class AlbumViewModel: ObservableObject {
    ...
    init(
        getAlbumMemoriesUseCase: GetAlbumMemoriesUseCase,
        getFavoriteMemoriesUseCase: GetFavoriteMemoriesUseCase
    ) {
        self.getAlbumMemoriesUseCase = getAlbumMemoriesUseCase
        self.getFavoriteMemoriesUseCase = getFavoriteMemoriesUseCase
    }

    func load() {
        let memories = showingFavoritesOnly
            ? getFavoriteMemoriesUseCase.execute()
            : getAlbumMemoriesUseCase.execute()
